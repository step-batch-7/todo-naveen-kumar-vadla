...
class User {
  ...
  addTaskToTodo(todoId, work) {
    this.todoList.addTaskToTodo(todoId, work);
  }
  removeTaskFromTodo(taskId, todoId) {
    this.todoList.removeTaskFromTodo(taskId, todoId);
  }
  changeTaskStatus(taskId, todoId) {
    this.todoList.changeTaskStatus(taskId, todoId);
  }
  editTodoTitle(todoId, newTitle) {
    this.todoList.editTodoTitle(todoId, newTitle);
  }
  editTodoTask(taskId, todoId, newWork) {
    this.todoList.editTodoTask(taskId, todoId, newWork);
  }
